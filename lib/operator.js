...
try {
  ...
  // if you're just running the examples you won't 
  // need CS and likely won't have it installed
}

exports.load = load;
exports.generateOptionLabel = generateOptionLabel;  // this should go in a util module
...
function load (operations, cacheDir) {
  ...
  fs.readFile(".operator", "utf8", function (err, data) {
    ...
    if (typeof operations == "function") operations = operations(operator);
    run(operations);
  });
}
